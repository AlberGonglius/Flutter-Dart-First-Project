...
import 'citas.dart';
import 'editarCitaPersonal.dart';
...
class PerfilCita extends StatelessWidget {
  ...
  PerfilCita({Key key, this.perfil, this.idperfil, this.paciente});
  @override
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: [
                              Text(
                                "Día: " +
                                    perfil[idperfil]["fecha"] +
                                    " Hora: " +
                                    perfil[idperfil]["hora"],
                              ...
                              Text("Telefono: " + paciente["telefono"]),
                              SizedBox(
                                height: 5,
                              ),
                              Center(child: Text("Descripción:")),
                              Center(
                                  child: Text(perfil[idperfil]["descripcion"])),
                              SizedBox(
                                height: 20,
                              ),
                              Text('Estado:'),
